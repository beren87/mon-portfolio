      ...
      <div className=' pt-2 sm:pt-10 md:pt-24'>
        ...
        <div className=' pt-8 sm:pt-4 pb-4 text-sm sm:text-lg'>
          ...
          <div className='text-center sm:text-center pb-3'>
            <Button className='hover:scale-110 active:scale-105 transition rounded-full font-normal h-7 w-auto dark:bg-accent dark:border-secondary border-2 dark:hover:bg-secondary-foreground text-accent'>
              <Mail className='mr-2 h-4 w-4 dark:text-secondary' />
              <Link
                href='mailto:berenger.fgs@gmail.com'
                className='flex items-center dark:text-secondary'
              >
        ...
        <div className='flex gap-2 pb-2 justify-center'>
          <Button className='hover:scale-110 active:scale-105 transition rounded-full font-normal h-7 w-auto dark:border-secondary dark:bg-accent bg-lightSecondary dark:hover:bg-secondary-foreground hover:bg-lightForeground border-2 border-lightForeground'>
            <Link
            ...
            >
              <svg
                ...
                height='18'
                width='18'
                className='dark:fill-svgbutton fill-lightPrimary'
              ...
              <span className='dark:text-secondary text-lightPrimary ml-1'>
                Github
              </span>
            </Link>
          </Button>
