  ...
  return (
    <section id='accueil' className='scroll-mt-[100rem]'>
      <div className='flex flex-col items-center justify-center '>
        <Image
          className='rounded-full border-2 dark:border-primary border-lightPrimary'
          width={158}
          height={158}
          src={"/berenger.jpg"}
        ...
        <h3 className='pb-3'>
          Statut :{" "}
          <span className='dark:text-popover text-lightPopover font-semibold'>
            Disponible
          </span>
        </h3>
        <div className='flex gap-2 pb-2 justify-center'>
          <Button className='hover:scale-110 active:scale-105 transition rounded-full font-normal h-7 w-auto dark:border-secondary dark:bg-accent bg-lightAccent dark:hover:bg-secondary-foreground hover:bg-lightForeground border-2 border-lightSecondary shadow-lg'>
            <Link
            ...
            >
              <svg
                ...
                height='18'
                width='18'
                className='dark:fill-svgbutton fill-lightSecondary'
              ...
              <span className='dark:text-secondary text-lightSecondary ml-1'>
                Github
              </span>
            </Link>
          </Button>
        ...
        <div className='flex gap-2 justify-center items-center'>
          <Button className='hover:scale-110 active:scale-105 transition rounded-full font-normal h-7 w-auto dark:border-secondary dark:bg-accent bg-lightAccent dark:hover:bg-secondary-foreground hover:bg-lightForeground border-2 border-lightSecondary shadow-lg'>
            <a
              ...
              className='flex items-center'
            >
              <ScrollText className='mr-2 h-4 w-4 dark:text-secondary text-lightSecondary' />{" "}
              <span className='dark:text-secondary text-lightSecondary'>
                Mon CV{" "}
              </span>
              <Download className='ml-2 h-4 w-4 dark:text-secondary text-lightSecondary' />
            </a>
          </Button>
          ...
          <Button className='hover:scale-110 active:scale-105 transition rounded-full font-normal h-7 w-auto dark:border-secondary dark:bg-accent bg-lightAccent dark:hover:bg-secondary-foreground hover:bg-lightForeground border-2 border-lightSecondary shadow-lg'>
            <Link
              ...
              className='flex items-center'
            >
              <Mail className='mr-2 h-4 w-4 dark:text-secondary text-lightSacondary' />
              <span className='dark:text-secondary text-lightSecondary'>
                Me contacter
              </span>
            </Link>
